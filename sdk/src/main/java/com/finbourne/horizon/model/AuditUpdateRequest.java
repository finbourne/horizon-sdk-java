...
public class AuditUpdateRequest {
  ...
  **/
  ...
  public AuditUpdateRequest schedulerRunId(UUID schedulerRunId) {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<AuditUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuditUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AuditUpdateRequest>() {
           @Override
